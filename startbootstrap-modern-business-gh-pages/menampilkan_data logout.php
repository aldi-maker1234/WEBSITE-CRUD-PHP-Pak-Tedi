...
<body class="d-flex flex-column h-100" id="mainBody">
<main class="flex-shrink-0">
    <!-- Navigation-->
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top fs-6">
        <div class="container px-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                    ...
                    <a class="nav-link dropdown-toggle" href="menampilkan_data.php" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Database
                    </a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="#tabel-siswa">Tabel Siswa</a>
                        <a class="dropdown-item" href="#tabel-sesi">Tabel Sesi</a>
                        <a class="dropdown-item" href="#tabel-presensi">Tabel Presensi</a>
                    </div>
        ...
        <button class="btn btn-secondary mx-5" id="toggleDarkMode"><i class="fas fa-sun" id="toggleIcon"></i>
        </button>
    </div>


    <!-- Search Form -->
    <form method="GET" action="menampilkan_data logout.php" style="text-align: center; margin: 20px;">
...
toggleDarkModeButton.addEventListener('click', () => {
    ...
    // Query for siswa
    echo "<h2 id='tabel-siswa'>Tabel Siswa</h2>";
    echo "<div style='text-align: center; margin-bottom: 10px;'>
        <a href='tambah.php?table=siswa' class='btn btn-primary'>Tambah Data Siswa</a>
      </div>";
    $query_siswa = "SELECT * FROM siswa WHERE Nama_siswa LIKE '%$search%' OR NISN LIKE '%$search%'";
    ...
    if ($result_siswa->num_rows > 0) {
        ...
        while ($row = $result_siswa->fetch_assoc()) {
            ...
            <td>" . $row['NISN'] . "</td><td>" . $row['Nama_siswa'] . "</td><td>" . $row['id_tingkatan'] . "</td><td>" . $row['Jurusan'] . "</td><td>" . $row['id_char'] . "</td><td><a href='edit.php?nisn=" . $row['NISN'] . "'>Edit</a> | <a href='hapus.php?NISN=" . $row['NISN'] . "' onclick='return confirm(\"Apakah Anda yakin ingin menghapus?\")'>
    ...
    // Query for sesi
    echo "<h2 id='tabel-sesi'>Tabel Sesi</h2>";
    echo "<div style='text-align: center; margin-bottom: 10px;'>
    ...
    if ($result_sesi->num_rows > 0) {
        ...
        echo "<h2 id='tabel-presensi'>Tabel Presensi Siswa</h2>";
        echo "<div style='text-align: center; margin-bottom: 10px;'>
            <a href='tambah_presensi.php?table=presensi' class='btn btn-primary'>Tambah Data Presensi</a>
          </div>";
        $query_presensi = "SELECT * FROM presensi WHERE id_siswa IN (SELECT id_siswa FROM siswa WHERE Nama_siswa LIKE '%$search%')";
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.1.3/dist/js/bootstrap.min.js" integrity="sha384-ChfqqxuZUCnJSK3+rCJAWEY+3q8qKNfNfNvF5aHf/nJGzlfhvCsiNrENWJZfN6A" crossorigin="anonymous"></script>
</main>
</body>
</html>